...
export default function StudentAttendance() {
  ...
  const filteredRecords = attendanceRecords.filter((record) => {
    ...
    const monthMatch =
      selectedMonth === "all" || new Date(record.date).getMonth() === Number.parseInt(selectedMonth, 10)
            ...
            <CardBody>
              <Stat>
                ...
                <Flex align="center" mt={2}>
                  <CircularProgress value={stats.rate} color="green.400" size="60px" thickness="8px">
          ...
          <Card>
            <CardBody>
              <Stat>
                ...
                <StatNumber>{isLoading ? <Skeleton height="24px" width="40px" /> : stats.present}</StatNumber>
          ...
          <Card>
            <CardBody>
              <Stat>
                ...
                <StatNumber>{isLoading ? <Skeleton height="24px" width="40px" /> : stats.absent}</StatNumber>
                <StatHelpText>Days</StatHelpText>
              </Stat>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardBody>
              <Stat>
                ...
                <StatNumber>{isLoading ? <Skeleton height="24px" width="40px" /> : stats.late}</StatNumber>
                <StatHelpText>Days</StatHelpText>
              </Stat>
            </CardBody>
          </Card>
                ...
                <Stack spacing={4}>
                  {courseStats.map((course) => (
                    <Box key={course.courseId}>
                      ...
                      <Progress
                        value={course.rate}
                        colorScheme={course.rate >= 90 ? "green" : course.rate >= 75 ? "blue" : "red"}
                        borderRadius="full"
                        size="sm"
                      />
                    </Box>
